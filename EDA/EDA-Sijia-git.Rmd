...
```{r OLS}
lm_CT <- lm(
  log(adj_sale_price) ~ log_dist_highway  + 
    ...
    exterior_condition +year_built_group + interior_condition + 
    building_code_description_new +
    number_of_bathrooms + number_of_bedrooms + quality_grade +
    log(distance_to_nearest_water+1) + zoning + zip_code +  central_air + general_construction + 
    separate_utilities + building_code_description_new + 
    crime_nn5 + MedHHInc + year_built_group + depth + LPSS_PER1000, 
  data = property_CT
)
