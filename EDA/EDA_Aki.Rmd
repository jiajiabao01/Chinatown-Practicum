...
The following code chunk took too much to load (too many properties to consider), so I'm going to limit it to the properties within 500m from highways to look at the immediate effects of highways on property prices.
