...
#    year_built >= 2010 & year_built < 2020 ~ "2000s-2010s",
    ...
    exterior_condition = factor(exterior_condition_recode),
  
    interior_condition_recode = case_when(
      interior_condition %in% c(2, NA) ~ "Good",
      interior_condition %in% c(1,4,6)~ "Average",
      interior_condition %in% c(3,5,7) ~ "Below Average",
      TRUE ~ "Unknown"
    ),
    interior_condition = factor(interior_condition_recode),
    ...
    quality_grade = factor(quality_grade_recode),
