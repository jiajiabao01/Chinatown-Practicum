...
```{r i676effects_exploring features}
# Numeric variables
...
```{r i676effects_model}
i676_price_reg <- lm(adjusted_sale_price ~ dist_to_closest_highwaym + 
                       residential +  # internal characteristics
                       factor(zip_code), # neighborhood effects (via zip code for now)
                     data = propi676_500)

summary(i676_price_reg)

i676_logprice_reg <- lm(log_price ~ dist_to_closest_highwaym + 
                          residential + # internal characteristics
                          factor(zip_code), # neighborhood effects (via zip code for now)
                        data = propi676_500)

summary(i676_logprice_reg)
